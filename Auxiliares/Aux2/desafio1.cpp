...
// codigo original realizado por Peter Goldsborough, disponible en: https://github.com/goldsborough/k-means/blob/master/cpp/k-means.cpp 
// usage: k_means <data-file> <k> [iterations] [runs]
// k_means "data.csv" 3 300 10  en caso de querer correr 10 sola vez el código
...
int main(int argc, const char* argv[]) {
  ...
  std::cerr << "Tiempo promedio: " << total_elapsed / number_of_runs << "s ("
